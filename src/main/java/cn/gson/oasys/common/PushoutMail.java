...
public class PushoutMail {
	...
	public static String myEmailAccount = "Hubadminton@163.com";
    public static String myEmailPassword = "humengzhi...";
 ...
 // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1211960323@qq.com";
